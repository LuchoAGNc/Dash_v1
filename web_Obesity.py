...
def main():
    ...
    if choice == 'Datos':
        ...
        c3.selectbox("Merienda ?", tipo_Meriendas_options)
        ...
        c4.selectbox("Consume alcohol ?", tipo_C_alcohol_options)
        tipo_Medio_transporte_options = df['Medio_transporte'].unique().tolist()
        c5.selectbox("Que medio de transporte usa?", tipo_Medio_transporte_options)
        c2.button('Predecir')
